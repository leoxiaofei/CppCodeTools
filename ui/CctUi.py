...
class frmStringToEnum ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 500,300 ), style = 0 )
...
class frmNameToClass ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 671,507 ), style = wx.TAB_TRAVERSAL )
